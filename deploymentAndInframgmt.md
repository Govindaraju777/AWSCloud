...
|---------------------------|----------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------|
| AWS CodeCommit            | Git hosting service, version control service                                     | Hosting private Git repositories for team collaboration on source code                                              |
| AWS CodeBuild             | Continuous integration service, build automation service                         | Automating the build and testing process for a web application                                                      |
| AWS CodePipeline          | Continuous delivery service, deployment automation service                       | Setting up a continuous integration/continuous deployment (CI/CD) pipeline for a mobile app                         |
| AWS CodeStar              | Integrated development environment (IDE), development project management service | Managing the development lifecycle of a web application project, including source code, build, and deployment       |
| AWS Cloud9                | Cloud-based IDE, online development environment                                  | Collaboratively editing and debugging code with team members in real-time                                           |
| AWS Systems Manager (SSM) | Systems management service, configuration management service                     | Automating server configuration and patch management across a fleet of EC2 instances                                |
| AWS OpsWorks              | Configuration management service, application lifecycle management service       | Managing the deployment and scaling of a multi-tier web application using Chef recipes for configuration management |
